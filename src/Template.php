...
namespace Silverslice\ExcelTemplate;
...
class Template
{
    ...
    public function open($file)
    {
        ...
        $this->tempFilename = tempnam($this->getTempDir(), 'xlsx');
        ...
        if ($res !== true) {
            ...
            throw new \Exception("Unable to unpack xlsx file");
        }
    ...
    public function save($filename)
    {
        if (isset($this->contents)) {
            $this->zip->addFromString('xl/sharedStrings.xml', $this->contents);
        }
    ...
    {
        if (!isset($this->contents)) {
            $this->contents = $this->joinVariables($this->zip->getFromName('xl/sharedStrings.xml'));
        }
